...
console.log('The doubles of all numbers are', doubled);
...
console.log('The upper case of all languages is', upperCased);
const firstLetters = languages.map(language => language[0]);
console.log('The first letter of each language is', firstLetters);
